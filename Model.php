...
abstract class Model
{
    ...
    public function errorMessages()
    {
        return [
            ...
            self::RULE_EMAIL => 'The email address must be valid email address.',
            self::RULE_MIN => 'Min length of password must be {min}.',
            self::RULE_MAX => 'Max length of password must be less than {max}.',
